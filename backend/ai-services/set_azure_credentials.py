...
def set_azure_credentials():
    # Azure endpoint and API key - SET THESE IN YOUR ENVIRONMENT
    AZURE_ENDPOINT = os.getenv("AZURE_AI_ENDPOINT", "https://your-azure-endpoint.cognitiveservices.azure.com/")
    AZURE_API_KEY = os.getenv("AZURE_AI_KEY", "your-azure-api-key-here")
