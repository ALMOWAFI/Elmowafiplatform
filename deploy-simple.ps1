# Simple Deployment Script for Enhanced Elmowafiplatform
# This starts just the essential services first

Write-Host "Starting Simple Enhanced Elmowafiplatform..." -ForegroundColor Green
...
try {
    ...
    Write-Host "Docker Desktop is still starting. Please wait a moment and try again." -ForegroundColor Red
    exit 1
}
